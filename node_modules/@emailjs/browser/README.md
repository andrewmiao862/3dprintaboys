...
emailjs.send('service_bi7jf4p', 'template_3dprintaboys', templateParams).then(
  function (response) {
...
emailjs.sendForm('service_bi7jf4p', 'template_3dprintaboys', '#myForm').then(
  function (response) {
    console.log('SUCCESS!', response.status, response.text);
  },
  function (err) {
...
emailjs
  .send('service_bi7jf4p', 'template_3dprintaboys', templateParams, {
    publicKey: 'NDtKfn1UXGhrSdHzu',
  })
  .then(
    (response) => {
      console.log('SUCCESS!', response.status, response.text);
